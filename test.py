...
from utils import AttnLabelConverter, Averager, TransformerLabelConvertor
...
def test(opt):
    ...
    if 'transformer' in opt.Prediction:
        criterion = torch.nn.CrossEntropyLoss(ignore_index=2).to(device)  # ignore padding token
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--Prediction', type=str, required=True, help='Prediction stage. transfomer|Attn')
    parser.add_argument('--num_fiducial', type=int, default=20, help='number of fiducial points of TPS-STN')
    parser.add_argument('--input_channel', type=int, default=1, help='the number of input channel of Feature extractor')
    parser.add_argument('--output_channel', type=int, default=512,
                        help='the number of output channel of Feature extractor')
    parser.add_argument('--hidden_size', type=int, default=256, help='the size of the LSTM hidden state')
    parser.add_argument('--encoder_count', type=int, default=6, help='number of encoders in transformer')
    parser.add_argument('--decoder_count', type=int, default=6, help=' number of decoders in transformer')
    parser.add_argument('--attention_heads', type=int, default=2, help='number of attention heads in transformer')
