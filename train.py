...
if __name__ == '__main__':
    ...
    #TODO add code to change opt.character value according to language parameter and add punctuation character list
    # to to opt.character list. do the same in test.py and demo.py
